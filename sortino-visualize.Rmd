...
Take a quick peek at the rolling 6-month for the dates September of 2006 through January of 2007.  3 of the observations show an infinite Sortino! When we calculate Sortino over short time periods, strange results can occur. 
...
The rolling 6-month has so many bizarre spikes, e.g. a reading of 22 on August 9, 2009 and a reading of 30 on April 30, 2013 before breaching 100 in 2016! It nicely emphasizes how we need to be careful with the Sortino Ratio, short time periods and rolling applications.

Let's see how the rolling 24-month compares.

```{r}
sortino_roll_24 <- rollapply(portfolio_returns_xts, 24, 
                           function(x) SortinoRatio(x))
...
Ah, much better. We can see the movements and how the Sortino has changed through the life of this portfolio, but within a reasonable range of 1.4 to -0.36.

The spikes and plunges are good markers for further investigation. The trough in 2009 is reflective of the credit crunch. What about the free fall at February of 2016? And the spike at end of 2013? 
